...
| Preview | `POST /preview/leads/` | **Free** | masked results, no charge |
...
- **Preview** endpoints (`POST /preview/leads/`, `/preview/leads/count/`) — masked results, no charge.
...
- **Preview** returns real (masked) leads — free.
